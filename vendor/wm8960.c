...
#define wm8960_reset(c)	snd_soc_write(c, WM8960_RESET, 1)
...
static int wm8960_probe(struct snd_soc_codec *codec)
{
    ...
    snd_soc_write(codec, WM8960_BYPASS1, reg | 0x80);
    reg = snd_soc_read(codec, WM8960_LOUT1);
    snd_soc_write(codec, WM8960_LOUT1, reg | 0x7F);
    reg = snd_soc_read(codec, WM8960_ROUT1);
    snd_soc_write(codec, WM8960_ROUT1, reg | 0x7F);
    reg = snd_soc_read(codec, WM8960_ADDCTL2);
    snd_soc_write(codec, WM8960_ADDCTL2, reg & 0xFFF7);
    reg = snd_soc_read(codec, WM8960_INBMIX1);
    snd_soc_write(codec, WM8960_INBMIX1, reg | 0xE);
    reg = snd_soc_read(codec, WM8960_INBMIX2);
    snd_soc_write(codec, WM8960_INBMIX2, reg | 0xE);
    reg = snd_soc_read(codec, WM8960_LOUTMIX);
    snd_soc_write(codec, WM8960_LOUTMIX, reg & 0x10F | 0x80);
    reg = snd_soc_read(codec, WM8960_ROUTMIX);
    snd_soc_write(codec, WM8960_ROUTMIX, reg & 0x10F | 0x80);
    reg = snd_soc_read(codec, WM8960_POWER3);
    snd_soc_write(codec, WM8960_POWER3, reg | 0xC);
    reg = snd_soc_read(codec, WM8960_LOUT2);
    snd_soc_write(codec, WM8960_LOUT2, reg | 0x7F);
    reg = snd_soc_read(codec, WM8960_ROUT2);
    snd_soc_write(codec, WM8960_ROUT2, reg | 0x7F);
